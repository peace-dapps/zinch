...
interface ConnectedWalletMetadata {
    ...
    id: string;
    /** The wallet logo, either a URL string or an embedded SVG component. */
    icon?: string | EmbeddedSVG;
}
/**
 * Object representation of a base connected wallet from a wallet connector.
...
interface PrivyClientConfig {
    ...
    /**
     * CSP nonce attached to entrypoint scripts on the host page. Required when the
     * page is served with a strict CSP (e.g. `script-src 'nonce-X' 'strict-dynamic'`).
     * The SDK forwards this value to third-party loaders that need it
     * (today: the Cloudflare Turnstile CAPTCHA loader, whose `srcdoc` iframe is
     * not covered by `'strict-dynamic'`).
     *
     * @example
     * // Next.js App Router
     * import {headers} from 'next/headers';
     * const nonce = (await headers()).get('x-nonce') ?? undefined;
     * <PrivyProvider config={{scriptNonce: nonce}}>...</PrivyProvider>
     */
    scriptNonce?: string;
    /**
