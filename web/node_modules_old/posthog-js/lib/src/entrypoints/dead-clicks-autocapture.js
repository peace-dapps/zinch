...
var LazyLoadedDeadClicksAutocapture = /** @class */ (function () {
    ...
    LazyLoadedDeadClicksAutocapture.prototype.stop = function () {
        ...
        globals_1.assignableWindow.removeEventListener('touchstart', this._onTouchStart, { capture: true });
        globals_1.assignableWindow.removeEventListener('touchend', this._onTouchEnd, { capture: true });
        globals_1.assignableWindow.removeEventListener('touchcancel', this._onTouchCancel, { capture: true });
    ...
    LazyLoadedDeadClicksAutocapture.prototype._startSwipeObserver = function () {
        (0, utils_1.addEventListener)(globals_1.assignableWindow, 'touchstart', this._onTouchStart, { capture: true, passive: true });
        (0, utils_1.addEventListener)(globals_1.assignableWindow, 'touchend', this._onTouchEnd, { capture: true, passive: true });
        ...
        (0, utils_1.addEventListener)(globals_1.assignableWindow, 'touchcancel', this._onTouchCancel, { capture: true, passive: true });
    };
